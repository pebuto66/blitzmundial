...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Rapid Risk — Dominio Mundial" },
      { name: "twitter:description", content: "Juego de estrategia por turnos estilo Risk para 2 a 6 jugadores en una sola pantalla." },
